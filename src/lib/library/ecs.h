...
void entity_children(FluaState& state);     // entity -> children_iterator
void destroy_entity(FluaState& state);      // entity ->
void create_empty_entity(FluaState& state); // [name] -> entity
void clone_entity(FluaState& state);        // entity, [name] -> clonedEntity
